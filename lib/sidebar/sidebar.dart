                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          Text('Dona Medicos', style: TextStyle(
                            color: Colors.white,
                            fontSize: 25
                          ),),
                        ],
                     ...
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.StockClickedEvent);
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.BuyClickedEvent);
                        },
                      ),
                      MenuItem(
                     ...
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.NotificationClickedEvent);
                      ...
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.AnalysisClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.people,
                        ...
                        onTap: () {
                          onIconPressed();
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.EmployeeClickedEvent);
                        },
                      ),
                      MenuItem(
                        ...
                        onTap: () {
                          onIconPressed();
                     BlocProvider.of<NavigationBloc>(context).add(NavigationEvents.AccountsClickedEvent);
                        },
                      ),
                      MenuItem(
                        icon: Icons.person,
